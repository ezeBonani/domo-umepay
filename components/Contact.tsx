  ...
  return (
    <section className="contact py-2 mb-4 md:mt-8" id="contact">
      <div className="wrapper w-full font-serif flex flex-col justify-center items-center">
        <div className="social flex flex-col bg-slate-100  p-0 rounded-md gap-8 md:items-center md:flex-row md:justify-center text-sm text-center">
          <div className="item flex flex-col items-center justify-center gap-2 w-[150px] ">
            <a
              href={whatsapp}
              className="hover:scale-[1.1] cursor-pointer transition-all text-sm gap-2"
              target="blank"
          ...
          <div className="item flex flex-col items-center justify-center gap-2 w-[150px]">
            <a
              ...
              rel="noreferrer nofollow"
            >
              <Image src="/airbnb.png" alt="airbnb" width={35} height={35} />
            </a>
            <span>Airbnb</span>
          </div>
        </div>
