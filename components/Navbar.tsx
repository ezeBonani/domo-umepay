...
function Navbar() {
  ...
  return (
    <nav className="flexBetween gap-20 padding-container z-30 py-3 sticky top-0 bg-white w-full font-serif">
      ...
      {/* Responsibe Menu */}
      <Image src="/menu.png" alt="menu" width={32} height={32} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="inline-block cursor-pointer lg:hidden z-50" onClick={handleMenu} />
      
      <ul className={`absolute top-0 items-center justify-evenly z-40 duration-500 transition-all bg-slate-800 opacity-90 text-white h-[100vh] ${isOpen ? "w-[100vw] right-0 py-8 lg:w-0 lg:right-[-50px] flex flex-col " : "w-0 right-[-50px]"}`}>
