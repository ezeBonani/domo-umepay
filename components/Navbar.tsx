...
function Navbar() {
  ...
  return (
    <nav className="flexBetween gap-20 padding-container z-30 py-1 md:py-3 sticky top-0 bg-white w-full font-serif">
      ...
      {/* Responsibe Menu */}
      <Image src="/menu.png" alt="menu" width={32} height={32} sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" className="inline-block cursor-pointer lg:hidden z-50 bg-white" onClick={handleMenu} />
