  ...
  return (
    <section id="location" className="mb-6">
      <div className="wrapper w-full md:w-3/4 md:mx-auto flex flex-col justify-center items-center py-8 font-serif">
        <p className='wrapper text-base text-center pb-6 px-6 md:w-3/4'>
          El Domo Umepay se encuentra en la localidad de Villa Yacanto de Calamuchita a 1150 msnm, provincia de Córdoba. A 1 hora aprox en auto desde Villa General Belgrano. 
        </p>
