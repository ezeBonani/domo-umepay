...
export const NAV_LINKS = [
  ...
  { href: '#domo_umepay', key: 'domo_umepay', label: 'Domo Umepay' },
  { href: '#services', key: 'services', label: 'Servicios' },
  { href: '#images', key: 'images', label: 'Imágenes' },
  { href: '#pricing', key: 'pricing', label: 'Precios' },
  { href: '#contact', key: 'contact', label: 'Contactanos' },
...
export const IMAGES = [
  ...
  {src:"https://res.cloudinary.com/ezebonani/image/upload/v1716398557/domo%20umepay/12_xbyxpw.webp", alt:"domo12"},
  {src:"https://res.cloudinary.com/ezebonani/image/upload/v1716398553/domo%20umepay/13_hhjug1.webp", alt:"domo13"},
  {src:"https://res.cloudinary.com/ezebonani/image/upload/v1716398558/domo%20umepay/14_sll2gr.webp", alt:"domo14"},
...
export const dataURL = "data:image/webp;base64,"
